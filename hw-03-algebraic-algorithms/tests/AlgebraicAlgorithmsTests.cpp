...
TEST(AlgebraicAlgorithmsTests, NoRealRoots) {
...
TEST(AlgebraicAlgorithmsTests, TwoDistinctRoots) {
	SquareEquationSolver solver;
...
TEST(AlgebraicAlgorithmsTests, DoubleRoot) {
	SquareEquationSolver solver;
...
TEST(AlgebraicAlgorithmsTests, CoefficientAZeroThrows) {
	SquareEquationSolver solver;
...
TEST(AlgebraicAlgorithmsTests, DoubleRootWithSmallDiscriminant) {
	SquareEquationSolver solver;
	double a = 1.0;
...
TEST(AlgebraicAlgorithmsTests, NaNOrInfCoefficients) {
	SquareEquationSolver solver;
